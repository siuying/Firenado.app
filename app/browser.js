System.register(['../alt'], function (_export) {
  'use strict';

  var alt, SearchActions;

  function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  return {
    setters: [function (_alt) {
      alt = _alt['default'];
    }],
    execute: function () {
      ...
      _export('default', alt.createActions(SearchActions));
    }
  };
});
System.register(['../alt'], function (_export) {
...
System.register(['alt'], function (_export) {
  ...
  return {
    ...
    execute: function () {
      _export('default', new Alt());
    }
  };
});
System.register(['react', './components/PiratePlayApp.react'], function (_export) {
  'use strict';

  var React, PiratePlayApp, polyfill;
  return {
    setters: [function (_react) {
      React = _react['default'];
    }, function (_componentsPiratePlayAppReact) {
      PiratePlayApp = _componentsPiratePlayAppReact['default'];
    }],
    execute: function () {
      polyfill = require("babel/polyfill");

      React.render(React.createElement(PiratePlayApp, null), document.getElementById('react'));
    }
  };
});
System.register(['react', 'alt/utils/connectToStores', './Searcher.react', './TorrentItemList.react', './TorrentStatus.react', '../stores/TorrentStore', '../constants/TorrentStates'], function (_export) {
  'use strict';

  var React, connectToStores, Searcher, TorrentItemList, TorrentStatus, TorrentStore, TorrentStates, PrivatePlayApp;
  ...
  return {
    setters: [function (_react) {
      React = _react['default'];
    }, function (_altUtilsConnectToStores) {
      connectToStores = _altUtilsConnectToStores['default'];
    }, function (_SearcherReact) {
      Searcher = _SearcherReact['default'];
    }, function (_TorrentItemListReact) {
      TorrentItemList = _TorrentItemListReact['default'];
    }, function (_TorrentStatusReact) {
      TorrentStatus = _TorrentStatusReact['default'];
    }, function (_storesTorrentStore) {
      TorrentStore = _storesTorrentStore['default'];
    }, function (_constantsTorrentStates) {
      TorrentStates = _constantsTorrentStates['default'];
    }],
    execute: function () {
      PrivatePlayApp = (function (_React$Component) {
        _inherits(PrivatePlayApp, _React$Component);

        function PrivatePlayApp() {
          _classCallCheck(this, _PrivatePlayApp);

          _get(Object.getPrototypeOf(_PrivatePlayApp.prototype), 'constructor', this).apply(this, arguments);
        }
        ...
        _createClass(PrivatePlayApp, [{
          ...
          value: function renderSearch() {
            return React.createElement(
              ...
              React.createElement(TorrentItemList, null)
            );
          }
        }, {
          key: 'renderTorrentInfo',
          value: function renderTorrentInfo() {
            return React.createElement(
              'div',
              { id: "container" },
              React.createElement(TorrentStatus, null)
            );
          }
        }], [{
          key: 'getStores',
          ...
          value: function getPropsFromStores(props) {
            var state = TorrentStore.getState();
            return {
              state: state.state
            };
          }
        ...
        PrivatePlayApp = connectToStores(PrivatePlayApp) || PrivatePlayApp;
        return PrivatePlayApp;
      })(React.Component);

      _export('default', PrivatePlayApp);
    }
  };
});
System.register(['alt/utils/connectToStores', 'react', '../stores/SearchStore', '../actions/SearchActions'], function (_export) {
  'use strict';

  var connectToStores, React, SearchStore, SearchActions, Searcher;
  ...
  return {
    setters: [function (_altUtilsConnectToStores) {
      connectToStores = _altUtilsConnectToStores['default'];
    }, function (_react) {
      React = _react['default'];
    }, function (_storesSearchStore) {
      SearchStore = _storesSearchStore['default'];
    }, function (_actionsSearchActions) {
      SearchActions = _actionsSearchActions['default'];
    }],
    execute: function () {
      Searcher = (function (_React$Component) {
        ...
        Searcher = connectToStores(Searcher) || Searcher;
        return Searcher;
      })(React.Component);

      _export('default', Searcher);
    }
  };
});
System.register(['react', '../actions/TorrentActions'], function (_export) {
  'use strict';

  var React, TorrentActions, TorrentFile;
  ...
  return {
    setters: [function (_react) {
      React = _react['default'];
    }, function (_actionsTorrentActions) {
      TorrentActions = _actionsTorrentActions['default'];
    }],
    execute: function () {
      TorrentFile = (function (_React$Component) {
      ...
      _export('default', TorrentFile);
    }
  };
});
System.register(['react', 'alt/utils/connectToStores', './TorrentFileItem.react', '../stores/TorrentStore'], function (_export) {
  'use strict';

  var React, connectToStores, TorrentFileItem, TorrentStore, TorrentFileList;
  ...
  return {
    setters: [function (_react) {
      ...
      connectToStores = _altUtilsConnectToStores['default'];
    }, function (_TorrentFileItemReact) {
      TorrentFileItem = _TorrentFileItemReact['default'];
    }, function (_storesTorrentStore) {
      TorrentStore = _storesTorrentStore['default'];
    }],
    execute: function () {
      TorrentFileList = (function (_React$Component) {
        _inherits(TorrentFileList, _React$Component);

        function TorrentFileList() {
          _classCallCheck(this, _TorrentFileList);

          _get(Object.getPrototypeOf(_TorrentFileList.prototype), 'constructor', this).apply(this, arguments);
        }

        _createClass(TorrentFileList, [{
          key: 'render',
          value: function render() {
            var _this = this;
            ...
            var files = this.props.files.map(function (f) {
              return React.createElement(TorrentFileItem, {
                key: f.path,
                file: f,
                selected: _this.props.selectedFile == f });
            });
            return React.createElement(
              'div',
              { className: "dropdown" },
        ...
        var _TorrentFileList = TorrentFileList;
        TorrentFileList = connectToStores(TorrentFileList) || TorrentFileList;
        return TorrentFileList;
      })(React.Component);

      _export('default', TorrentFileList);
    }
  };
});
System.register(['react', '../stores/SearchStore', '../actions/TorrentActions', 'moment'], function (_export) {

  // the date formate is either MM-DD hh:mm OR MM-DD YYYY
  'use strict';

  var React, SearchStore, TorrentActions, moment, TorrentItem;
  ...
  return {
    ...
    execute: function () {
      TorrentItem = (function (_React$Component) {
        _inherits(TorrentItem, _React$Component);

        function TorrentItem() {
          _classCallCheck(this, TorrentItem);

          _get(Object.getPrototypeOf(TorrentItem.prototype), 'constructor', this).apply(this, arguments);
        }

        _createClass(TorrentItem, [{
          key: 'render',
          value: function render() {
      ...
      _export('default', TorrentItem);
    }
  };
});
System.register(['react', 'alt/utils/connectToStores', '../stores/SearchStore', '../actions/SearchActions', './TorrentItem.react'], function (_export) {
  'use strict';

  var React, connectToStores, SearchStore, SearchActions, TorrentItem, TorrentItemList;
  ...
  function getTorrentItem(torrent) {
    return React.createElement(TorrentItem, { key: torrent.link,
  ...
  return {
    setters: [function (_react) {
      ...
      SearchActions = _actionsSearchActions['default'];
    }, function (_TorrentItemReact) {
      TorrentItem = _TorrentItemReact['default'];
    }],
    execute: function () {
      TorrentItemList = (function (_React$Component) {
        _inherits(TorrentItemList, _React$Component);

        function TorrentItemList() {
          _classCallCheck(this, _TorrentItemList);

          _get(Object.getPrototypeOf(_TorrentItemList.prototype), 'constructor', this).apply(this, arguments);
        }

        _createClass(TorrentItemList, [{
          key: 'render',
          value: function render() {
            ...
            var items = this.props.torrents.map(getTorrentItem);
            return React.createElement(
              'table',
        ...
        var _TorrentItemList = TorrentItemList;
        TorrentItemList = connectToStores(TorrentItemList) || TorrentItemList;
        return TorrentItemList;
      })(React.Component);

      _export('default', TorrentItemList);
    }
  };
});
System.register(['react', 'alt/utils/connectToStores', 'wcjs-player', '../stores/TorrentStore', '../actions/TorrentActions', '../constants/TorrentStates', './TorrentFileList.react'], function (_export) {
  'use strict';

  var React, connectToStores, wjs, TorrentStore, TorrentActions, TorrentStates, TorrentFileList, TorrentStatus;
  ...
  return {
    setters: [function (_react) {
      ...
      connectToStores = _altUtilsConnectToStores['default'];
    }, function (_wcjsPlayer) {
      wjs = _wcjsPlayer['default'];
    }, function (_storesTorrentStore) {
      TorrentStore = _storesTorrentStore['default'];
    }, function (_actionsTorrentActions) {
      TorrentActions = _actionsTorrentActions['default'];
      ...
      TorrentStates = _constantsTorrentStates['default'];
    }, function (_TorrentFileListReact) {
      TorrentFileList = _TorrentFileListReact['default'];
    }],
    execute: function () {
      TorrentStatus = (function (_React$Component) {
        _inherits(TorrentStatus, _React$Component);

        function TorrentStatus() {
          _classCallCheck(this, _TorrentStatus);

          _get(Object.getPrototypeOf(_TorrentStatus.prototype), 'constructor', this).apply(this, arguments);
        }
        ...
        _createClass(TorrentStatus, [{
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement('div', { id: "player", className: "embed-responsive embed-responsive-16by9" })
            );
          }
        }, {
          ...
          value: function renderFileListView() {
            return React.createElement(
              'div',
              { className: "file-list" },
              React.createElement(TorrentFileList, null)
            );
          }
        }, {
          key: '_onClick',
        ...
        var _TorrentStatus = TorrentStatus;
        TorrentStatus = connectToStores(TorrentStatus) || TorrentStatus;
        return TorrentStatus;
      })(React.Component);

      _export('default', TorrentStatus);
    }
  };
});
...
System.register(['../alt', '../actions/SearchActions', 'thepiratebay'], function (_export) {
  'use strict';

  var alt, SearchActions, thepiratebay, SearchStore;
  ...
  return {
    setters: [function (_alt) {
      ...
      SearchActions = _actionsSearchActions['default'];
    }, function (_thepiratebay) {
      thepiratebay = _thepiratebay['default'];
    }],
    execute: function () {
      ...
      SearchStore = (function () {
        ...
        _createClass(SearchStore, [{
          ...
          value: function onSearch(query) {
            ...
            // category 200 = video
            thepiratebay.search(query, { category: 200 }).then(function (torrents) {
      ...
      _export('default', alt.createStore(SearchStore, 'SearchStore'));
    }
  };
});
System.register(['../alt', 'peerflix', 'numeral', 'network-address', '../actions/TorrentActions', '../constants/TorrentStates'], function (_export) {
  'use strict';

  var alt, peerflix, numeral, address, TorrentActions, TorrentStates, engine, toBytes, TorrentStore;
  ...
  return {
    setters: [function (_alt) {
      ...
      peerflix = _peerflix['default'];
    }, function (_numeral) {
      numeral = _numeral['default'];
    }, function (_networkAddress) {
      address = _networkAddress['default'];
    }, function (_actionsTorrentActions) {
      TorrentActions = _actionsTorrentActions['default'];
    }, function (_constantsTorrentStates) {
      TorrentStates = _constantsTorrentStates['default'];
    ...
    execute: function () {
      ...
      TorrentStore = (function () {
        function TorrentStore() {
          _classCallCheck(this, TorrentStore);

          this.bindActions(TorrentActions);
          this.reset();
        }

        _createClass(TorrentStore, [{
          key: 'onOpenTorrentUrl',
          value: function onOpenTorrentUrl(url) {
      ...
      _export('default', alt.createStore(TorrentStore, 'TorrentStore'));
    }
  };
});
System.register([], function (_export) {
